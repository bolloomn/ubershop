					...
					if(isset($val_data[0]) && is_array($val_data)){
						...
						{							
							...
							<div class="phoeniixx_discount_min_max_div"> 
								...
								<input type="number" placeholder="Min Quantity" name="min_val[]"  class="min_val" value="<?php echo isset($val_data[$i]['min_val'])?$val_data[$i]['min_val']:''; ?>" />

								<input type="number"  placeholder="Max Quantity" name="max_val[]" class="max_val" value="<?php echo isset($val_data[$i]['max_val'])?$val_data[$i]['max_val']:''; ?>" />

								<input type="number" step='any' placeholder="Discount Value" name="discount[]" class="discount" value="<?php echo isset($val_data[$i]['discount'])?$val_data[$i]['discount']:''; ?>" />
