		...
		public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
			...
			if ( $this->has_children ) {
				...
				if( 'item-hide-mobile' !== $mega_settings['item-hide-mobile'] ) {
					...
					$link_after_label  = sprintf( apply_filters( 'tm_mega_menu_arrow_mobile_format', '<label for="tm-megamenu-toggle-' . $item->ID . '" class="mega-menu-mobile-arrow"><i class="fa fa-angle-down %1$s"></i></label>' ), $arrow_level );
