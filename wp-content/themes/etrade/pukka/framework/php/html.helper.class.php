	...
	class HtmlHelper {
		...
		public function printMenuPage($page=false) {
			...
			<div id="pukka-heading" class="pukka-clearfix">
				<div id="pukka-logo">
					<a href="<?php echo esc_url(PUKKA_HOMEPAGE); ?>" target="_blank"><img src="<?php echo esc_url(PUKKA_FRAMEWORK_URI) .'/images/admin-logo.png'; ?>" /></a>
				</div> <!-- #pukka-logo -->

				<h1 id="pukka-settings-title"><?php echo esc_html(PUKKA_THEME_NAME) .' '. esc_html(PUKKA_THEME_VERSION); ?> </h1>

				<a href="#" class="pukka-button-primary pukka-save-settings"><?php _e('Save settings', 'pukka'); ?></a>
			</div> <!-- #pukka-heading -->
