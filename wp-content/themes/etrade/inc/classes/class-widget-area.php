...
if ( ! class_exists( 'Solosshopy_Widget_Area' ) ) {

	/**
	 * Class Solosshopy_Widget_Area.
	 */
	class Solosshopy_Widget_Area {
		...
		function __construct() {
			...
			add_action( 'solosshopy_render_widget_area', array( $this, 'render' ) );
		}
		...
		public function render( $area_id ) {
			...
			$area_id        = apply_filters( 'solosshopy_rendering_current_widget_area', $area_id );
			...
			$classes = apply_filters( 'solosshopy_widget_area_classes', $classes, $area_id );
	 ...
	 * @return object
	 */
	function solosshopy_widget_area() {
		return Solosshopy_Widget_Area::get_instance();
	}

	solosshopy_widget_area();
}
