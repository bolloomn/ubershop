...
if ( ! class_exists( 'Solosshopy_Elementor' ) ) {

	/**
	 * Define Solosshopy_Elementor class
	 */
	class Solosshopy_Elementor {
		...
		public function edit_scripts() {
			...
			$js_core = solosshopy_theme()->get_core()->modules['cherry-js-core'];
			$ui      = solosshopy_theme()->get_core()->init_module( 'cherry-ui-elements' );
			$builder = solosshopy_theme()->get_core()->init_module( 'cherry-interface-builder' );
			...
			wp_localize_script( 'solosshopy-edit', 'solosshopyEditData', $this->get_data() );
		...
		public function get_widgets() {
			...
			foreach ( $wp_widget_factory->widgets as $widget ) {
				...
				if ( false === strpos( $widget->widget_id, 'solosshopy' ) ) {
					continue;
				}
...
/**
 * Returns instance of Solosshopy_Elementor
 *
 * @return object
 */
function solosshopy_elementor() {
	return Solosshopy_Elementor::get_instance();
}

solosshopy_elementor();
