...
add_filter( 'cherry_trend_posts_date_args', 'solosshopy_cherry_trend_posts_date_args' );
add_filter( 'cherry_trend_posts_comments_args', 'solosshopy_cherry_trend_posts_comments_args' );
add_filter( 'cherry_trend_posts_author_args', 'solosshopy_cherry_trend_posts_author_args' );
add_filter( 'cherry_trend_posts_category_args', 'solosshopy_cherry_trend_posts_category_args' );
add_filter( 'cherry_trend_posts_tag_args', 'solosshopy_cherry_trend_posts_tag_args' );
add_filter( 'cherry_trend_posts_button_args', 'solosshopy_cherry_trend_posts_button_args' );
 ...
 * @return array
 */
function solosshopy_cherry_trend_posts_date_args( $args = array() ) {
 ...
 * @return array
 */
function solosshopy_cherry_trend_posts_comments_args( $args = array() ) {
 ...
 * @return array
 */
function solosshopy_cherry_trend_posts_author_args( $args = array() ) {
	$args['prefix'] = esc_html__( 'by ', 'solosshopy' );
 ...
 * @return array
 */
function solosshopy_cherry_trend_posts_category_args( $args = array() ) {
 ...
 * @return array
 */
function solosshopy_cherry_trend_posts_tag_args( $args = array() ) {
 ...
 * @return array
 */
function solosshopy_cherry_trend_posts_button_args( $args = array() ) {
