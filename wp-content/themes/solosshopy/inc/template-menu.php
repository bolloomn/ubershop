 ...
 * @return string
 */
function solosshopy_get_main_menu() {
	$args = apply_filters( 'solosshopy_main_menu_args', array(
		'theme_location'   => 'main',
		'container'        => '',
		'menu_id'          => 'main-menu',
		'echo'             => false,
		'fallback_cb'      => 'solosshopy_set_nav_menu',
		'fallback_message' => esc_html__( 'Set main menu', 'solosshopy' ),
	) );
 ...
 * @return void
 */
function solosshopy_main_menu() {

	$main_menu  = solosshopy_get_main_menu();
	$menu_style = get_theme_mod( 'header_menu_style', solosshopy_theme()->customizer->get_default( 'header_menu_style' ) );
 ...
 * @return void
 */
function solosshopy_vertical_main_menu( $slide = 'left', $args = array() ) {

	$default_args = apply_filters( 'solosshopy_vertical_menu_args', array(
		...
		'button-back-inner-html'  => '<i class="nc-icon-mini arrows-1_tail-left"></i><span class="navigation-button__text">' . esc_html__( 'Back', 'solosshopy' ) . '</span>',
		'button-close-inner-html' => '<i class="nc-icon-mini ui-1_simple-remove"></i><span class="navigation-button__text">' . esc_html__( 'Close', 'solosshopy' ) . '</span>',
	) );

	$args        = wp_parse_args( $args, $default_args );
	$menu        = solosshopy_get_main_menu();
 ...
 * @return void
 */
function solosshopy_footer_menu() {
	if ( ! get_theme_mod( 'footer_menu_visibility', solosshopy_theme()->customizer->get_default( 'footer_menu_visibility' ) ) ) {
		return;
	}

	$args = apply_filters( 'solosshopy_footer_menu_args', array(
		...
		'echo'             => false,
		'fallback_cb'      => 'solosshopy_set_nav_menu',
		'fallback_message' => esc_html__( 'Set footer menu', 'solosshopy' ),
	) );
 ...
 * @return void
 */
function solosshopy_top_menu() {

	if ( ! solosshopy_is_top_menu_visible() ) {
		return;
	}

	wp_nav_menu( apply_filters( 'solosshopy_top_menu_args', array(
		'theme_location'  => 'top',
		'container'       => 'div',
 ...
 * @return bool
 */
function solosshopy_is_top_menu_visible() {

	$is_visible = false;

	if ( has_nav_menu( 'top' ) && get_theme_mod( 'top_menu_visibility', solosshopy_theme()->customizer->get_default( 'top_menu_visibility' ) ) ) {
		$is_visible = true;
	}
 ...
 * @return void
 */
function solosshopy_login_link() {

	if ( ! solosshopy_is_login_link_visible() ) {
		return;
	}
 ...
 * @return bool
 */
function solosshopy_is_login_link_visible() {

	$is_visible = false;

	if ( has_nav_menu( 'top' ) && get_theme_mod( 'login_link_visibility', solosshopy_theme()->customizer->get_default( 'login_link_visibility' ) ) ) {
		$is_visible = true;
	}
 ...
 * @return string
 */
function solosshopy_get_social_list( $context, $type = 'icon' ) {
	static $instance = 0;
	$instance++;
	...
	$args = apply_filters( 'solosshopy_social_list_args', array(
		...
		'echo'             => false,
		'fallback_cb'      => 'solosshopy_set_nav_menu',
		'fallback_message' => esc_html__( 'Set social menu', 'solosshopy' ),
	), $context, $type );
 ...
 * @return null|string
 */
function solosshopy_set_nav_menu( $args ) {
 ...
 * @return void
 */
function solosshopy_menu_toggle( $menu_id ) {
	$format = apply_filters(
		'solosshopy_menu_toggle_html',
 ...
 * @return void
 */
function solosshopy_vertical_menu_toggle( $menu_id ) {
	$format = apply_filters(
		'solosshopy_vertical_menu_toggle_html',
