	...
	class PukkaSocialMedia {
		...
		*/
		public function printOpenGraphTags(){
			...
			// og_type
			if( !is_front_page() && !is_home() && !is_singular('product') && (is_singular() || is_page()) ){
				$og_type = "article";
			}
			...
			*/
			...
			if( is_singular('product') && function_exists('is_woocommerce') ){
...
//				$out .= '<meta property="og:price:currency" content="'. $currency .'" />' . "\n";
		...
		*/
		...
		public function printSocialButtons() {
			...
			echo '<div class="social-buttons clearfix">' ."\n";
			// Facebok like button
