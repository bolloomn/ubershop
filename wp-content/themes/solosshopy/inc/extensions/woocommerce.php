 ...
 */
function solosshopy_is_woocommerce_activated() {
	return class_exists( 'woocommerce' );
}

add_filter( 'solosshopy_queried_object_id', 'solosshopy_woo_set_shop_page' );
 ...
 * @return int
 */
function solosshopy_woo_set_shop_page( $id ) {
