...
class Pukka_Banner_Widget extends WP_Widget {
	...
	public function __construct() {
		...
		parent::__construct(
			'pukka-banner-widget',
			__( 'Pukka - Banner widget', 'pukka' ),
			array(
				'classname'  => 'pukka-banner-widget',
				'description' => __( 'Banner widget', 'pukka' )
			)
		);
	...
	public function widget( $args, $instance ) {
		...
		$cache = wp_cache_get( 'pukka-banner-widget', 'widget' );
		...
		$wrap_style = '';
		if( $instance['banner_height'] ){
			$wrap_style .= 'min-height: '. $instance['banner_height'] .'px;';
		}

		if( $instance['widget_margin_top'] ){
			$wrap_style .= 'margin-top: '. $instance['widget_margin_top'] .'px;';
		}

		$widget_string .= '<div class="widget-banner-wrap" style="'. $wrap_style .'">' ."\n";
		...
		if( $background_style != '' ){
			$widget_string .= '<div class="widget-banner-img" style="'. $background_style .'"></div>' ."\n";
		}


		$widget_string .= '<div class="widget-banner-content">' ."\n";
		...
		$widget_string .= '</div> <!-- .banner-content -->' ."\n";

		$widget_string .= '</div> <!-- .banner-wrap -->' ."\n";
		...
		wp_cache_set( 'pukka-banner-widget', $cache, 'widget' );
	...
	{
    	wp_cache_delete( 'pukka-banner-widget', 'widget' );
	}
	/**
	...
	public function update( $new_instance, $old_instance ) {
		...
		$instance['widget_margin_top'] = $new_instance['widget_margin_top'];
		...
		$instance['image_parallax'] = isset($new_instance['image_parallax']) ? 'on' : '';
	...
	public function form( $instance ) {
        ...
        <p>
			<label for="<?php echo $this->get_field_id( 'widget_margin_top' ); ?>"><?php _e( 'Banner top margin:','pukka' ); ?></label>
			<input id="<?php echo $this->get_field_id( 'widget_margin_top' ); ?>" name="<?php echo $this->get_field_name( 'widget_margin_top' ); ?>" type="text" value="<?php echo esc_attr($instance['widget_margin_top']); ?>" size="2" />px
        </p>

		<p>
			<label for="<?php echo $this->get_field_id( 'banner_height' ); ?>"><?php _e( 'Banner height:','pukka' ); ?></label>
			<input  id="<?php echo $this->get_field_id( 'banner_height' ); ?>" name="<?php echo $this->get_field_name( 'banner_height' ); ?>" type="text" value="<?php echo esc_attr( $instance['banner_height'] ); ?>" size="3" />px
		</p>
		...
		<p>
			<input id="<?php echo $this->get_field_id( 'image_parallax' ); ?>" name="<?php echo $this->get_field_name( 'image_parallax' ); ?>" class="checkbox" type="checkbox" value="on" <?php checked($instance['image_parallax'], 'on') ?> />
			<label for="<?php echo $this->get_field_id( 'image_parallax' ); ?>"><?php _e( 'Parallax?','pukka' ); ?></label>
		</p>
...
add_action( 'widgets_init', function() {
	register_widget( 'Pukka_Banner_Widget' );
} );
