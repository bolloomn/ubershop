...
if ( ! function_exists( 'woocommerce_template_loop_product_title' ) ) {
	...
	function woocommerce_template_loop_product_title() {
		echo '</div><h2 class="woocommerce-loop-product__title">' . get_the_title() . '</h2>';
	}
}
...
if ( ! function_exists( 'woocommerce_template_loop_product_link_open' ) ) {
	...
	function woocommerce_template_loop_product_link_open() {
		...
		echo '<a href="' . esc_url( $link ) . '" class="woocommerce-LoopProduct-link woocommerce-loop-product__link"><div class="product_img">';
	}
}
...
if ( ! function_exists( 'woocommerce_widget_shopping_cart_button_view_cart' ) ) {
	...
	function woocommerce_widget_shopping_cart_button_view_cart() {
		echo '<a href="' . esc_url( wc_get_cart_url() ) . '" class="button wc-forward">' . esc_html__( 'View cart1', 'woocommerce' ) . '</a>';
	}
}
...
if ( ! function_exists( 'woocommerce_checkout_payment' ) ) {
	...
	function woocommerce_checkout_payment() {
		...
		wc_get_template( 'checkout/payment.php', array(
			...
			'order_button_text'  => apply_filters( 'woocommerce_order_button_text', __( 'Захиалга батлах', 'woocommerce' ) ),
		) );
	}
}
